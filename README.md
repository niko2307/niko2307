<div align="center">
  <h1 style="font-size: 3em; margin-bottom: 10px; background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
    ¡Hola, soy <span style="color:#667eea;">Nicolás</span> 👋!
  </h1>
  <p style="font-size: 1.3em; color: #4a5568; margin-bottom: 30px;">
    <strong>Full Stack Developer | Freelance | Apasionado por crear soluciones web modernas</strong>
  </p>
  ...
  <div style="margin: 30px 0;">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&duration=4000&pause=1000&color=667eea&center=true&vCenter=true&multiline=true&width=600&height=100&lines=Spring+Boot+%2B+Angular+Developer;Freelancer+con+experiencia+real+en+proyectos;DevOps%2C+Docker+y+Despliegue+en+la+nube" alt="Typing SVG" />
  </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 30px 0;">
  ...
  <div style="padding: 25px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 20px; color: white; box-shadow: 0 8px 25px rgba(240, 147, 251, 0.3); transition: transform 0.3s ease;">
    ...
    <p style="margin: 0; opacity: 0.9; line-height: 1.6;">Freelancer con experiencia en proyectos reales: periódicos digitales, sistemas de reservas y más</p>
  </div>
...
<div style="border: 2px solid #e1e5e9; border-radius: 20px; padding: 30px; background: linear-gradient(145deg, #ffffff, #f8f9fa); box-shadow: 0 12px 35px rgba(0,0,0,0.15); transition: transform 0.3s ease; position: relative; overflow: hidden;">
  ...
  <p style="margin: 0 0 25px 0; color: #4a5568; line-height: 1.8; font-size: 1.1em;">
    <strong>Periódico deportivo digital</strong> - Plataforma web informativa con noticias deportivas y resultados en tiempo real.
    Diseñé la arquitectura completa y desarrollé la plataforma desde cero.
  </p>
  <div style="margin-bottom: 20px;">
    <span style="background: #667eea; color: white; padding: 5px 12px; border-radius: 20px; font-size: 0.9em; margin-right: 8px;">✅ API REST</span>
...
<div style="border: 2px solid #e1e5e9; border-radius: 20px; padding: 30px; background: linear-gradient(145deg, #ffffff, #f8f9fa); box-shadow: 0 12px 35px rgba(0,0,0,0.15); transition: transform 0.3s ease; position: relative; overflow: hidden;">
  ...
  <h3 style="margin: 0 0 20px 0; color: #2d3748; font-size: 1.6em;">🏠 Plataforma de Arriendo</h3>
  <p style="margin: 0 0 25px 0; color: #4a5568; line-height: 1.8; font-size: 1.1em;">
    <strong>Sistema de gestión de propiedades</strong> - Proyecto completo para gestión de propiedades en alquiler con dashboard, usuarios y publicaciones.
  </p>
  <div style="margin-bottom: 20px;">
    <span style="background: #f093fb; color: white; padding: 5px 12px; border-radius: 20px; font-size: 0.9em; margin-right: 8px;">🔹 CRUD Completo</span>
...
<div style="border: 2px solid #e1e5e9; border-radius: 20px; padding: 30px; background: linear-gradient(145deg, #ffffff, #f8f9fa); box-shadow: 0 12px 35px rgba(0,0,0,0.15); transition: transform 0.3s ease; position: relative; overflow: hidden;">
  ...
  <h3 style="margin: 0 0 20px 0; color: #2d3748; font-size: 1.6em;">📱 App Móvil Android</h3>
  <p style="margin: 0 0 25px 0; color: #4a5568; line-height: 1.8; font-size: 1.1em;">
    <strong>Aplicativo Android</strong> - Aplicación móvil para gestión de mapas y ubicación con autenticación y base de datos en tiempo real.
  </p>
  <div style="margin-bottom: 20px;">
    <span style="background: #4facfe; color: white; padding: 5px 12px; border-radius: 20px; font-size: 0.9em; margin-right: 8px;">🔸 UI Fluida</span>
